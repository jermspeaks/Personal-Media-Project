...
# puts movie_array
imdb = FilmBuff::IMDb.new
movie = imdb.find_by_id('tt0405094')
print [movie.title, "http://www.imdb.com/title/tt0405094", "tt0405094", "08/2011", movie.tagline, movie.plot, movie.runtime, movie.rating, movie.votes, movie.poster_url, movie.genres.join(", "), movie.release_date].join(",")
